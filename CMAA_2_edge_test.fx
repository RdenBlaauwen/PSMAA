...
uniform float _LCAFactor <
  ui_type = "slider";
	ui_category = "Edge Detection";
	ui_label = "LCA Factor";
	ui_min = 0.0; ui_max = .15; ui_step = 0.01;
> = .1;
...
#define g_CMAA2_LocalContrastAdaptationAmount       _LCAFactor
...
technique CMAA_2_edge_test < ui_tooltip = "A port of Intel's CMAA 2.0 (Conservative Morphological Anti-Aliasing) to ReShade\n\n"
								  "Ported to ReShade by: Lord Of Lunacy";>
{
	pass
	{

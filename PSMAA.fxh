...
namespace PSMAA
{
  ...
  namespace Pass
  {
        ...
        out float3 color)
    {
      ...
      float mod = getSmoothingIterationsMod(deltas, maxLocalLuma);
      ...
      if (PSMAA_SMOOTHING_DELTA_WEIGHT_DEBUG)
      {
        ...
        float3 result = smooth(texcoord, offset, colorTex, blendSampler, PSMAA_SMOOTHING_THRESHOLD, maxIterations);
